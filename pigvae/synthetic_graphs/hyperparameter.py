...
def add_arguments(parser):
    ...
    parser.add_argument('-e', '--num_epochs', default=3000, type=int)
    parser.add_argument("--num_eval_samples", default=25000, type=int)
    parser.add_argument("--eval_freq", default=12, type=int) # batch: 32 (1875-60000, 19-600, 282-6000), batch: 64 (94-6000), batch: 128 (47-6000)
